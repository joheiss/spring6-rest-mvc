...
public class BeerCSVRecord {
    ...
    @CsvBindByName(column = "count.x") private Integer count;
    ...
    @CsvBindByName(column = "brewery_id") private Integer breweryId;
    @CsvBindByName private Float ounces;
    @CsvBindByName private String style2;
    @CsvBindByName(column = "count.y") @CsvBindByName private String count_y;
